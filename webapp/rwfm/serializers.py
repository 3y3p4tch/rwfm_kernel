...
from rwfm.models import Id, SubId, ObjId, UserId, GroupId, SockId, Addr, Connection, PipeId
...
class PipeIdSerializer(serializers.Serializer):
    hostid = serializers.CharField()
    uid = serializers.CharField()
    pid = serializers.IntegerField()
    fd = serializers.IntegerField()
    
    pipe_ref_num = serializers.IntegerField()


    def create(self, validated_data):
        
        pipeid, created =  PipeId.objects.get_or_create(**validated_data)
        return pipeid
    ...
    def update(self, instance, validated_data):
        ...
        instance.pipe_ref_num = validated_data.get('pipe_ref_num', instance.pipe_ref_num)
